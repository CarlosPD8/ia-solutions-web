    ...
    >
      <div className="section-shell flex min-h-[100svh] items-center py-16 md:py-20">
        <div className="grid w-full gap-10 md:grid-cols-[1fr_1fr] md:items-center">
          ...
          <div className="scene-hero-orbit surface-card relative overflow-hidden p-4 sm:p-8">
            <div className="absolute inset-0 bg-[radial-gradient(560px_300px_at_55%_48%,rgba(43,111,255,0.22),transparent_66%)]" />
